          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div>
                  <label className={`block mb-1.5 sm:mb-2 text-xs sm:text-sm font-medium flex items-center gap-1.5 sm:gap-2 ${
                  ...
                  <input
                    ...
                    className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base rounded-lg transition-all duration-300 outline-none ${
                      mode === 'dark'
                        ? 'bg-gray-700 border-2 border-gray-600 focus:border-blue-500 text-white placeholder-gray-500'
                        : 'bg-gray-50 border-2 border-gray-200 focus:border-blue-500 text-gray-900 placeholder-gray-400'
                    }`}
                  />
                  {errors.applyUrl && <span className='text-red-500 text-sm'>{errors.applyUrl}</span>}
                  <p className={`text-xs mt-1 ${mode === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                    Optional: Redirect applicants to your company's career page
                  </p>
                </div>
              </div>
