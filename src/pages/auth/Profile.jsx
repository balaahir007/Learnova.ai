...
const defaultProfile = {
  ...
  goals: ['Your first goal', 'Your second goal']
};
...
const Profile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...defaultProfile,
    ...authUser,             // overwrite defaults with real data
    profilePicture: profile || defaultProfile.profilePicture
  });
              ...
              <div className="flex items-end gap-6 md:-mt-8">
                ...
                <div className="flex-1 pb-4">
                  {isEditing ? (
                    ...
                    <h2 className={`text-3xl font-bold ${textPrimary}`}>{profileData.username}</h2>
                  )}
