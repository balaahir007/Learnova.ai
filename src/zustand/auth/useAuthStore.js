...
const useAuthStore = create(
  persist(
    (set, get) => ({
      ...
      deleteState: { isLoading: false, failureReason: "", success: false },
      ...
      logout: async () => {
        ...
        try {
          ...
          // Clear authUser from state and localStorage
          set({ authUser: null });
          ...
          // Optionally, explicitly remove persisted storage
      ...
      deleteAccount: async () => {
        try {
          ...
          set({
            deleteState: { isLoading: false, success: true, failureReason: "" },
          });
        } catch (error) {
          set({
            deleteState: {
