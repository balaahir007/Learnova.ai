...
const App = () => {
  ...
  const showNavbar = !isResetPasswordPage && !isAdminPage && !isStudySpace && !isCreateStudySpace && !isLoginOrRegisterPage && !isTeacherDashboardPage && !isRecruiterDashboardPage;
  ...
  if (isCheckingAuth && !isStudySpace) return <Spinner mode={mode} />;
