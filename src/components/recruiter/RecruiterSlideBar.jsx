...
import { MdDashboard, MdWork, MdSettings, MdHelpOutline } from "react-icons/md";
...
const RecruiterSlideBar = ({ extendMenu, setExtendMenu }) => {
  ...
  const menus = [
    ...
    { label: "jobs", icon: <MdWork className="text-xl" />, title: "Jobs", path: "jobs" },
    // { label: "internship", icon: <PiGraduationCapFill className="text-xl" />, title: "Internship", path: "internship" },
    { label: "candidaties", icon: <FaUsers className="text-xl" />, title: "Candidaties", path: "candidaties" },
...
export default RecruiterSlideBar;
