...
const CreateStudySpaceForm = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex z-50  items-center justify-center bg-black/50 p-4" onClic>
      <div
        ref={modalRef}

        className={`max-w-2xl w-full max-h-[90vh] overflow-y-auto rounded-2xl shadow-xl p-8 bg-backGray`}
      >
        <div className={`text-center mb-8 ${textPrimary}`}>
          <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
            <Users className="w-8 h-8 text-white" />
          </div>
          <h1 className={`text-3xl font-bold mb-2 ${textPrimary}`}>

            Create Study Space</h1>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border ${textSecondary} rounded-lg focus:ring-2 focus:ring-primary transition-all
    ${borderColor} ${inputBg} ${placeholderColor}
    ${errors.name ? "border-red-500" : ""}`}
          ...
          <div>
            ...
            <select
              ...
              onChange={handleInputChange}
              className={`w-full px-4 py-3 border   rounded-lg focus:ring-2 focus:ring-primary transition-all ${textSecondary}
    ${borderColor} ${inputBg} ${placeholderColor}
    ...
    ${errors.goal ? "border-red-500" : ""}`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary transition-all ${textSecondary}
    ${borderColor} ${inputBg} ${placeholderColor}
    ${errors.techSkills ? "border-red-500" : ""}`}
            />
    ...
    ${errors.tags ? "border-red-500" : ""}`} />
          ...
          <div>
            ...
            <div className="flex gap-4">
              <label className={`${textSecondary} flex items-center`}>
                <input
                  type="radio"
                  name="visibility"
                  value="private"
    ...
    ${errors.rules ? "border-red-500" : ""}`} />
          ...
          <button
            ...
            className="w-full bg-primary hover:bg-secondary text-white py-3 px-6 rounded-lg font-semibold  focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
